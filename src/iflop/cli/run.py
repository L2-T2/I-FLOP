...
from iflop.api import result_summary, run_flop_envwise, run_flop_obs, run_iflop
...
def main() -> None:
    ...
    parser.add_argument("--method", choices=["flop_obs", "flop_envwise", "iflop"], default="iflop")
    ...
    if args.method == "flop_obs":
        ...
        result = run_iflop(dataset, backend=args.backend)
