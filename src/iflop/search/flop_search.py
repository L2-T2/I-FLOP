...
from iflop.search.grow_shrink import LocalScorer, parent_sets_for_order
from iflop.search.ils import default_perturbation_size, perturb_order
from iflop.search.local_search import local_reinsertion_search_incremental
from iflop.search.state import SearchResult, _CandidateState
...
def run_flop_search(
    ...
    *,
    score_key: str,
    config: SearchConfig | None = None,
    metadata: _abc.Mapping[str, object] | None = None,
) -> SearchResult:
