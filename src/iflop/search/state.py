...
class SearchResult:
    ...
    total_score: float
    score_key: str
    score_metadata: dict[str, object] = _dataclasses.field(default_factory=dict)
    trajectory: list[float] = _dataclasses.field(default_factory=list)
...
class _CandidateState:
    ...
    parents: dict[int, set[int]]
    adjacency: np.ndarray
    local_scores: dict[int, float] = _dataclasses.field(default_factory=dict)
    score_vector: tuple[int, int] | None = None
